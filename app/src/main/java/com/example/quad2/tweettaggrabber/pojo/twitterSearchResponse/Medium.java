...
public class Medium {
     ...
     * @param expandedUrl
     */
    public Medium(long id, String idStr, List<Long> indices, String mediaUrl, String mediaUrlHttps, String url, String displayUrl, String expandedUrl, String type, Sizes sizes, long sourceStatusId, String sourceStatusIdStr, long sourceUserId, String sourceUserIdStr) {
        super();
        this.id = id;
        this.idStr = idStr;
