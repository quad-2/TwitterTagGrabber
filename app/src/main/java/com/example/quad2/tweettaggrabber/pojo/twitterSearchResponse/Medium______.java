...
public class Medium______ {
     ...
     * @param idStr
     */
    public Medium______(long id, String idStr, List<Long> indices, String mediaUrl, String mediaUrlHttps, String url, String displayUrl, String expandedUrl, String type, Sizes___ sizes) {
        super();
        this.id = id;
        this.idStr = idStr;
